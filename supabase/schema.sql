...
-- Realtime for messages: a new row pushes a live update (open-thread append,
-- header unread badge) instead of requiring a page refresh. RLS above
-- already scopes which INSERTs each subscribing client receives.
